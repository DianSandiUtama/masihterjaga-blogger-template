            ! function (t, e) {
              t.InfiniteScroll = function (n) {
                ...
                function f() {
                  return L.innerHTML = p.text.loading, T = !0, y ? (M.classList.add(p.state.loading), l("loading", [p]), void u(y, function (t, n) {
                    ...
                    if (o = o && o[0] ? o[0].innerHTML : "", a.length && s.length) {
                      ...
                      d.insertAdjacentHTML("afterend", h.innerHTML), c(), y = i.length ? i[0].href.replace(/\+/g, "%2B") : !1, T = !1, j++, l("load", [p, t, n])
                    }
                  }, function (t, e) {
                ...
                var h = null,
                  ...
                  j = 1;
                if (y.length) {
                  y = y[0].href.replace(/\+/g, "%2B"), H.insertAdjacentHTML("afterbegin", '<span class="fi" id="#fi:0"></span>'), h = e.createElement("div"), c();
                  var A = function () {
